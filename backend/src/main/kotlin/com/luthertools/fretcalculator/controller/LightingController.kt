...
import com.luthertools.fretcalculator.service.LightingGeneratorService
...
class LightingController(
    ...
    private val lightingGeneratorService: LightingGeneratorService,
) {
    ...
    fun generate(@RequestBody request: LightingRequest): ResponseEntity<LightingResponse> {
        ...
        val svg = lightingGeneratorService.generateSvg(request, positions)
