...
data class InstrumentPreset(
    ...
    companion object {
        val ALL: List<InstrumentPreset> = listOf(
            ...
            InstrumentPreset(
                "Electric Guitar 25.5\" (648 mm)",
                648.0,
                42.0,
                52.0,
                22,
                184.0,
                StringPreset.GUITAR_6,
                BridgeStyle.ELECTRIC
            ),
            InstrumentPreset(
                "Electric Guitar 24.75\" (628 mm)",
                628.0,
                42.0,
                52.0,
                22,
            ...
            InstrumentPreset(
                "Bass Guitar 5-string 34\" (864 mm)",
                864.0,
                45.0,
                58.0,
                20,
